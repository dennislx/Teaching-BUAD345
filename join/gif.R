...
animated_titles <- as.character(cut(
    1:61,
    breaks = 3,
    labels = c("long", 'pivot_wider(long, names_from=key, values_from=val)', "wide")
))
...
pv_anim_long2wide <- animate(pv_anim, width=600, height=700, nframes=60, end_pause=0)
anim_save('/home/dalab1/project/web-dev/blog/my_staff/my_course/ggplot2/content/basics/figs/pivot_wider.gif', pv_anim_long2wide)
